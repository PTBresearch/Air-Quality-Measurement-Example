...
def postInfluxdb(input):
    ...
    output = ""
    daten = json.loads(input)
    
    for sensor in daten['sensors']:
         for reading in sensor["readings"]:
            ...
            if sensor_value != "NULL":
                output = output + sensor_type + "," + "arduinoID=" + str(daten["arduino_board"]) + ",einheit=" + str(sensor_unit) + " " + str(sensor["name"]) + "=" + str(sensor_value) + " " + str(now) + "\n"
